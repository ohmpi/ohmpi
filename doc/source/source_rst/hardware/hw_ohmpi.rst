...
+------------------------------+--------------------------------+--------------------+------------------------+--------------------------+------------------------+
|4 electrodes-soil sample      |mb v2023                        |None                |Raspberry Pi 3 Model B  | 12V Battery              |                        |
|laboratory (only Rhoa)        |                                |                    |                        |                          |                        |
+------------------------------+--------------------------------+--------------------+------------------------+--------------------------+------------------------+
|4 electrodes soil sample      |mb v2024                        |None                |Raspberry Pi 3 Model B  | 12V Battery              |                        |
|laboratory (Rhoa and IP)      |                                |                    |                        |                          |                        |
+------------------------------+--------------------------------+--------------------+------------------------+--------------------------+------------------------+
|4 electrodes concrete sample  |mb v2024                        |None                |Raspberry Pi 3 Model B  | DPS5005                  |                        |
|Laboratory (Rhoa and IP)      |                                |                    |                        |                          |                        |
+------------------------------+--------------------------------+--------------------+------------------------+--------------------------+------------------------+
