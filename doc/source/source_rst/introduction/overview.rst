...
In :ref:`Hardware <../hardware>` we detail how to build each single module of an OHMPI system.
...
In :ref:`Hardware systems <../hardware_systems>` we detail examples of OHMPI systems assemblies in different versions.
